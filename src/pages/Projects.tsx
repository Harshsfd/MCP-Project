            ...
            {filteredProjects.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredProjects.map((project) => (
                  <div
                    key={project.id}
                    className="glass-card rounded-xl p-6 shadow-lg flex flex-col justify-between"
                  >
                    <div>
                    ...
                    <a
                      ...
                      download={project.title.replace(/\s+/g, "_") + ".jsx"}
                      className="mt-4 inline-block px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/80 text-center"
                    >
                      Download Code
                    </a>
                  </div>
